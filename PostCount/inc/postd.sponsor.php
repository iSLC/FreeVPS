...
<div class="col-lg-12">
    <div class="alert alert-warning"><strong>Note!</strong> The script can't tell whether Sponsors members own a VPS or not. Therefore the script allways assumes they do.</div>
</div>